...
| On-demand scanning | A fourteen-scanner fleet (Semgrep, deepsec, Checkov, Gitleaks, TruffleHog, Trivy, Grype, OSV-Scanner, Syft, GuardDog, Trivy IaC, Trivy Image, ZAP, Nuclei) you can launch from the UI or CLI — no pipeline required. |
