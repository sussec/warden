...
export function updateJiraIntegrationSetting(http: HttpClient, rootUrl: string, params?: UpdateJiraIntegrationSetting$Params, context?: HttpContext): Observable<StrictHttpResponse<boolean>> {
